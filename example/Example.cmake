...
# ==============================================================
  ...
  ENDIF()
   ...
   IF (ADD_FATAL_EXAMPLE)
      ...
      target_link_libraries(g3log-FATAL-contract ${G3LOG_SHARED_LIBRARY} ${EXAMPLE_PLATFORM_LINK_LIBRIES})
      target_link_libraries(g3log-FATAL-sigsegv ${G3LOG_SHARED_LIBRARY} ${EXAMPLE_PLATFORM_LINK_LIBRIES})
      target_link_libraries(g3log-FATAL-choice ${G3LOG_SHARED_LIBRARY} ${EXAMPLE_PLATFORM_LINK_LIBRIES})
   ELSE()
