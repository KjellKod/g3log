...
namespace
{
   ...
   int gShouldBeZero = 1;
   void DivisionByZero() {
      LOG(DBUG) << " trigger exit   Executing DivisionByZero: gShouldBeZero: "  << gShouldBeZero;
...
int main(int argc, char **argv)
{
   ...
   LOGF(DBUG, "Fatal exit example starts now, it's as easy as  %d", 123);
