...
9. Two versions of g3log exists.
    * This version: *[g3log](https://github.com/KjellKod/g3log)* : which is made to facilitate  easy adding of custom log receivers.  Its tested on at least the following platforms with Linux(Clang/gcc), Windows (mingw, visual studio 2013). My recommendation is to go with g3log if you have full C++17 support (C++14 support up to version: https://github.com/KjellKod/g3log/releases/tag/1.3.3).
...
Assume you have got your shiny C++17 compiler installed, you also need these tools to build g3log from source:
- CMake (*Required*)
